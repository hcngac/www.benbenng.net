...
},{}],"routing.js":[function(require,module,exports) {
"use strict";
...
var changePage = function changePage(html) {
    document.getElementsByTagName("main")[0].innerHTML = html;
};

var getTemplateHTML = function getTemplateHTML(template_id) {
...
router.on({
    ...
    'blog/:id': function blogId(params) {
        changePage(getTemplateHTML("page-blog"));
        document.getElementById("nav-blog").parentElement.classList.add("active");
    },
    ...
    'projects/:id': function projectsId(params) {
        changePage(getTemplateHTML("page-blog"));
        document.getElementById("nav-projects").parentElement.classList.add("active");
    },
    'contact': function contact(params) {
        changePage(getTemplateHTML("page-blog"));
        document.getElementById("nav-contact").parentElement.classList.add("active");
    },
    'search': function search(params, query) {
        changePage(getTemplateHTML("page-blog"));
    },
    '*': function _() {
        changePage(getTemplateHTML("page-about"));
...
},{}]},{},["../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","routing.js"], null)
//# sourceMappingURL=/routing.147fe519.map